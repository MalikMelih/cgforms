...
<head>
    ...
    <title>Çorumgaz Forms | Kargo Takip Formu</title>
...
<body>
    ...
    <!-- /Test Item -->
    <div id="invoice">
        <iframe src="docs/pdf/cargo/<?php echo $no;?>.PDF#toolbar=0&scrollbar=0&navpanes=0&scrollbar=0" width="100%" height="1070px" style="display: block;margin: 15px auto;max-width: 850px;background-color: #fff;border-radius: 6px;"></iframe>
    </div>
</body>
</html>
...
<div class="fleft box-2">
    <a class="d-print-inpt" href="qrcode.php?pg=cargo">
...
<div class="btn-group btn-group-sm d-print-none">
    <a href="javascript:window.print()" class="btn btn-light border text-black-50 shadow-none">
    <i class="fa fa-print"></i> Kaydet Ve Yazdır</a>
</div>
</footer>
</div>
</body>
