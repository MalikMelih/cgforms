...
<body>
	...
	<div class="fleft left-bar noprint" media="screen and (min-width: 900px)">
		...
		<!--<a><div onclick="search('search-bar')" class="fas fa-search white lbbtns objcntr cgbluehvr" title="Arama Yap"></div></a>-->
		<a><div onclick="search('search-bar')" class="fas fa-search white lbbtns objcntr cgbluehvr" title="Arama Yap"></div></a>
			<form method="POST" action="search.php">
				<!--<input id="search-bar" name="no" style="left: -300px;" class="search-bar" placeholder="Ne Arıyorsunuz?"/>-->
				<div id="search-bar" style="left:-400px;">
					<a href="qrcode.php?pg=index">
						<div onmouseover="qr('qr')" onmouseout="qr('code')" class="fa fa-qrcode" id="sb-div"></div>
					</a>
					<input id="sb-input" name="no" style="float:left;" placeholder="Barkod veya Form Numarasıyla Ara">
				</div>
			</form>
			...
			<div style="float: left;width: 60%;height: 2px;margin: 0 20%;background-color: gray;border-radius: 25px;opacity: 0.2;"></div>
			<a href="?pg=formslist"><div class="fas fa-id-card-alt white lbbtns objcntr cgbluehvr" title="Hurda Cihaz"></div></a>
		</div>
		<div class="fleft flbottom noprint">
			<a href="#"><div class="fas fa-cog white lbbtns objcntr cgbluehvr" title="Bulut'a Yedekle"></div></a>
			<a href="#"><div onclick="search('tb')" class="fas fa-user-alt white lbbtns objcntr cgreenhvr" title="Hesabım"></div></a>
			<a href="logout.php"><div id="tb" style="left: -400px;bottom: 65px;border-right: 4px solid #8dcf69;" class="search-bar">Çıkış Yap</div></a>
			<div style="float: left;width: 60%;height: 2px;margin: 0 20%;background-color: gray;border-radius: 25px;opacity: 0.2;"></div>
