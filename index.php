...
<body>
	...
	<div class="fleft left-bar noprint" media="screen and (min-width: 900px)">
		...
		<a>
			...
			<div style="float: left;width: 60%;height: 2px;margin: 0 20%;background-color: gray;border-radius: 25px;opacity: 0.2;"></div>
			<a href="?pg=create&type=cargo"><div class="fas fa-truck-loading white lbbtns objcntr cgreenhvr" title="Ürün Gönderimi"></div>
			...
			<a href="?pg=create&type=services"><div class="fas fa-box-open white lbbtns objcntr cgreenhvr" title="Gelen Ürün"></div>
			...
			<a href="?pg=create&type=delivery"><div class="fas fa-box white lbbtns objcntr cgreenhvr" title="Malzeme Teslim"></div>
			...
			<a href="?pg=create&type=scrap"><div class="fas fa-dolly-flatbed white lbbtns objcntr cgreenhvr" title="Hurda Cihaz"></div>
		...
		<div class="fleft flbottom noprint">
			<a href="?th=<?php echo $theme;?>"><div class="<?php echo $thicon; ?> white lbbtns objcntr cgbluehvr" title="<?php echo $thtext;?>"></div>
			...
			<a href="#"><div class="fas fa-cog white lbbtns objcntr cgbluehvr" title="Ayarları Düzenle"></div>
			...
			<a><div onclick="search('ab')" class="fas fa-user-alt white lbbtns objcntr cgreenhvr bars" title="Hesabım"></div>
