        ...
        <header>
            <div class="row align-items-center">
                    ...
                    <div class="col-sm-5 text-center text-sm-right" style="margin-left: -8%;">
                        <h4 class="text-7 mb-0" style="color: #3bb7e8;">Hurda Cihaz</h4>
...
?>
            ...
            <div class="card card-add">
                <div>
                    ...
                    <div class="fleft box-2">
                        <a href="qrcode.php?pg=scrap&type=eno&sno=<?php echo $sno?>">
                    ...
                    <div class="fright box-2">
                        <a href="qrcode.php?pg=scrap&type=eno&sno=<?php echo $eno?>">
                            <div class="fa fa-qrcode" id="form-qr"></div>
                        </a>
